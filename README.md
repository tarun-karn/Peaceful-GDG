...
Peaceful is a mental health **AI** powered chat assistant that guides and helps you to improve your mental health.
Peaceful website provides a user-friendly UI to learn about mental health.
...
#### System Design
Peaceful application runs on 4 server
- Frontend
- Backend
- WebSocket Server
- Email Server
